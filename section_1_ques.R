...
f_section_1_2_questions <- function(cancer_type_now,
  ...
  if(buttons_prognosis == 0){
    ...
    tagList(div(
      ...
      tags$li(div(style = "display: inline-block; vertical-align:middle; width: 400px;", HTML("I believe that OMST in cancers diagnosed in early stage is")),
      ...
      ifelse(buttons_next_que_2a > 0,
             tagList(div(
               ...
               tags$li(div(style = "display: inline-block; vertical-align:middle; width: 400px;", HTML("I believe that cancers diagnosed in late stage will have spent")),
